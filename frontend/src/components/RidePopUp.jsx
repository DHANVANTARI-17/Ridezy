            ...
            <h3 className='text-2xl font-semibold mb-5'>New Ride Available!</h3>
             <div className='flex items-center justify-between p-3 rounded-lg mt-4'>
               <div className='flex items-center gap-3 '>
                    ...
                    <h2 className='text-lg font-medium'>Rohini Pawar</h2>
            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                <div className='w-full mt-5'>
                    ...
                    <div className='flex items-center gap-5 p-3 border-b-2'>
                        ...
                        <div>
                            <h3 className='text-lg font-medium'>562/11-A</h3>
                            <p className='text-sm -mt-1 text-gray-600'>Powai Naka, Satara</p>
                        </div>
                    </div>
                    <div className='flex items-center gap-5 p-3 border-b-2'>
                        <i className="ri-map-pin-user-fill"></i>
                        <div>
                            <h3 className='text-lg font-medium'>562/11-A</h3>
                            <p className='text-sm -mt-1 text-gray-600'>Bombay Restaurant, Satara</p>
                        </div>
                    </div>
                    <div className='flex items-center gap-5 p-3 border-b-2'>
                        <i className="text-lg ri-map-pin-2-fill"></i>
